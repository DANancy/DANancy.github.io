...
export const projects: { title:string; description:string; tags:string[]; tone:string; href?:string; linkLabel?:string; titleZh:string; descriptionZh:string; linkLabelZh?:string }[] = [
  ...
  { title:"Lunch and Learn", titleZh:"午餐分享会", description:"A Lunch and Learn series I host and participate in at work. Sharing with colleagues keeps me accountable, pushes me to learn more, and turns technical ideas into useful conversations and hands-on learning.", descriptionZh:"这是我在工作中主持并参与的午餐学习分享。与同事分享让我保持学习动力，推动自己探索更多知识，也让技术理念变成有价值的讨论与动手实践。", tags:["Knowledge Sharing","AI","Community"], tone:"amber" },
  ...
  { title:"Home Essentials — Home Project", titleZh:"Home Essentials — 家居项目", description:"A home project focused on an Australian ecommerce destination for thoughtful gifts, home decor, craft supplies, and everyday essentials.", descriptionZh:"一个面向澳大利亚消费者的家居电商项目，提供礼品、家居装饰、手工用品和日常好物。", tags:["Ecommerce","Shopify","Retail"], tone:"cyan", href:"https://home-essentials.com.au/", linkLabel:"Visit Home Essentials", linkLabelZh:"访问 Home Essentials" },
];
