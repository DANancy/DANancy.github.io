...
export const projects: { title:string; description:string; tags:string[]; tone:string; href?:string; linkLabel?:string; titleZh:string; descriptionZh:string; linkLabelZh?:string }[] = [
  { title:"Senior Data Engineer", titleZh:"高级数据工程师", description:"Designing reliable, scalable data platforms and translating complex business needs into practical engineering outcomes.", descriptionZh:"设计可靠、可扩展的数据平台，将复杂的业务需求转化为实用的工程成果。", tags:["Data Platforms","Cloud","Leadership"], tone:"mint", href:"https://www.smartestenergy.com/en_AU/", linkLabel:"Visit SmartestEnergy Australia", linkLabelZh:"访问 SmartestEnergy Australia" },
  { title:"Lunch and Learn", titleZh:"午餐分享会", description:"Creating approachable knowledge-sharing sessions that turn technical ideas into useful conversations and hands-on learning.", descriptionZh:"通过轻松的知识分享，把技术理念转化为有价值的讨论和动手学习。", tags:["Knowledge Sharing","AI","Community"], tone:"amber" },
  ...
  { title:"Home Essentials", titleZh:"Home Essentials 家居项目", description:"An Australian ecommerce destination for thoughtful gifts, home decor, craft supplies, and everyday essentials.", descriptionZh:"面向澳大利亚消费者的电商网站，提供礼品、家居装饰、手工用品和日常好物。", tags:["Ecommerce","Shopify","Retail"], tone:"cyan", href:"https://home-essentials.com.au/", linkLabel:"Visit Home Essentials", linkLabelZh:"访问 Home Essentials" },
];
